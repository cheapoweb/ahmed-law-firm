...
const faqs = [
  { question: 'What types of personal injury cases do you handle?', answer: 'We handle a wide range of personal injury cases including auto accidents, medical malpractice, nursing home abuse, construction accidents, slip and fall incidents, wrongful death, and more. Our attorneys have over 10 years of combined experience across multiple practice areas.' },
