          ...
          <div className="hp3-locations-left">
            ...
            <div className="hp3-locations-social">
              ...
              <div className="hp3-locations-social-icons">
                <a
                  href="https://www.youtube.com/@AhmedLawFirm-YT"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={t('sections.locations.youtube')}
                ...
                <a
                  href="https://www.facebook.com/people/Ahmed-Law-Firm-PC/100071133752996/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.instagram.com/ahmedlawfirm"
                  target="_blank"
                  rel="noopener noreferrer"
